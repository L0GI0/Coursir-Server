...
export const createScripePaymentIntent = async (
    req: Request,
    res: Response,
): Promise<void> => {
...
export const createTransaction = async (
    ...
    try {
        ...
        res.status(500).json({ message: "Error creating transaction and entrollment", error})
    }
}
...
export const listTransactions = async (
    ...
    try {
        ...
        res.json({ message: "Transaction retreived successfully", data: transactions});
    } catch (error) {
